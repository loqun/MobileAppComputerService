...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void addNewCourse(String courseName, String courseDuration, String courseDescription, String courseTracks, String username) {
    ...
    public ArrayList<CourseModal> readCoursesUser(String username) {
        // on below line we are creating a
        // database for reading our database.
        SQLiteDatabase db = this.getReadableDatabase();

        // on below line we are creating a cursor with query to read data from database.
        Cursor cursorCourses = db.rawQuery("SELECT * FROM " + TABLE_NAME + " where username = ?", new String[]{username} );

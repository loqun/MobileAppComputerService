...
//                username = String.valueOf(textInputEditTextUsername.getText());
                ...
                if (it_bookingContactEmail.getText().toString().trim().matches(emailPattern)) {
                ...
                if(!name.equals("") && serviceID != null && !notes.equals("") && it_bookingContactEmail.getText().toString().trim().matches(emailPattern) && (PhoneNumberUtils.isGlobalPhoneNumber(phone)&& phone.length()>9) ) {
...
//                    progressBar.setVisibility(View.VISIBLE);
                    ...
                    finish();
                    Intent intent = new Intent(AddBookingDetail.this,BookingActivity.class);
                    startActivity(intent);

                }
                else{
                    Toast.makeText(getApplicationContext(), "All fields required and follow the format",Toast.LENGTH_SHORT).show();
                }

...
public class adminbookingRecycleView extends RecyclerView.Adapter<adminbookingRecycleView.ViewHolder> {
    ...
    String name;
    // constructor
    public adminbookingRecycleView(ArrayList<Booking> BookingArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adminrbooking_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.button_delete_booking.setOnClickListener(view -> {
            ...
            builder.setTitle("Do you want to approve this transaction ?");

            // Ask the final question
            builder.setMessage("Verified data cannot be undone.");
        ...
        holder.delbut.setOnClickListener(view -> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public Button button_delete_booking, delbut;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            description = tv_paymentStatus = itemView.findViewById(R.id.textView6);
